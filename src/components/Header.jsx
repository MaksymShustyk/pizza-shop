            ...
            <div className="conteiner">
                <Link to="/">
                    <div className="header-logo">
                        <img className="header-logo_img" src={logoImg} alt="Hot Pizza" width="25px"/>
                        <div>
                            <h2 className="header-logo_text large">hot pizza</h2>
                            <p className="header-logo_text small">Самая вкусная и горячая пицца</p>
                        </div>
                    </div>
                </Link>
                    ...
                    <Link to="/cart">
                        <Routes>
                            <Route path="/" exact element={
                                <Button className="header-cart_link">
                                    <span>{totalPrice} ₴</span>
                                    <div className="header-cart_link-delimiter"></div>
